...
import 'package:team_portfolio/apps/bmicalculatorApp/circular_button.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/constants.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/enums.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/icon_widget.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/result_screen.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/reusable_widget.dart';
import 'package:team_portfolio/apps/bmicalculatorApp/weight_heigth_widget.dart';
                            ...
                            children: [
                              ReUsableWidget(
                                ...
                                child: WeightHeightWidget(
                                  ...
                                  increment: () =>
                                      _increment(WeightOrAge.WEIGHT),
                                  decrement: () =>
                                      _decrement(WeightOrAge.WEIGHT),
                                ),
                              ),
                              const SizedBox(width: 20.0),
                              ReUsableWidget(
